...
},{"topojson-client":"../node_modules/topojson/node_modules/topojson-client/index.js","topojson-server":"../node_modules/topojson/node_modules/topojson-server/index.js","topojson-simplify":"../node_modules/topojson/node_modules/topojson-simplify/index.js"}],"data/homework-17/world.topojson":[function(require,module,exports) {
module.exports = "/world.b7ed7133.topojson";
},{}],"data/homework-17/world-cities.csv":[function(require,module,exports) {
module.exports = "/world-cities.5e73d3b0.csv";
...
Promise.all([d3.json(require('/data/homework-17/world.topojson')), d3.csv(require('/data/homework-17/world-cities.csv'))]).then(ready).catch(function (err) {
...
function ready(_ref) {
  ...
  var pops = datapoints.map(function (d) {
    return +d.population;
  });
  colorScale.domain([0, 750000]);
  console.log(d3.extent(pops));
  var countries = topojson.feature(json, json.objects.countries); // console.log(countries)
  ...
  svg.append('path').datum(graticule()).attr('d', path).attr('stroke', 'white').attr('stroke-width', '0.5').attr('fill', 'none').lower();
  d3.select('svg').style('background-color', 'black');
  svg.selectAll('circle').data(datapoints).enter().append('circle').attr('r', 0.8).attr('transform', function (d) {
    var coords = [d.lng, d.lat]; // coords is our long/lat pair
    // console.log(coords)
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","/data/homework-17/world.topojson":"data/homework-17/world.topojson","/data/homework-17/world-cities.csv":"data/homework-17/world-cities.csv"}]},{},["scripts/homework-17/01-map.js"], null)
