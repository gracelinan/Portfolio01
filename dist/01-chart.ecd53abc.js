...
d3.csv(require('/data/homework-15/countries.csv')).then(ready);
...
function ready(datapoints) {
  ...
  d3.select('#requirements').on('stepin', function () {
  ...
  svg.append('text').text('⟵ lower GDP').attr('class', 'gdp-note2').attr('text-anchor', 'middle').attr('font-size', 12).attr('x', width * 0.25).attr('y', height + 15);
  ...
  function render() {
    ...
    svg.selectAll('rect').attr('width', xPositionScale.bandwidth()).attr('height', function (d) {
      return height - yPositionScale(d.life_expectancy);
    }).attr('x', function (d) {
      return xPositionScale(d.country);
    }).attr('y', function (d) {
    ...
    svg.select('.gdp-note').attr('x', newWidth * 0.75);
    svg.select('.gdp-note2').attr('x', newWidth * 0.25); // Update axes
...
},{"d3":"../node_modules/d3/index.js","/data/homework-15/countries.csv":"data/homework-15/countries.csv"}]},{},["scripts/homework-15/01-chart.js"], null)
