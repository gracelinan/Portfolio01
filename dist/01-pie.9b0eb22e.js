...
var labelArc = d3.arc().innerRadius(radius).outerRadius(radius + 20);
var colorScale = d3.scaleOrdinal().range(['#7fc97f', '#beaed4', '#fdc086']);
d3.csv(require('/data/homework-13/time-breakdown.csv')).then(ready).catch(function (err) {
...
},{"d3":"../node_modules/d3/index.js","/data/homework-13/time-breakdown.csv":"data/homework-13/time-breakdown.csv"}]},{},["scripts/homework-13/01-pie.js"], null)
