...
},{"topojson-client":"../node_modules/topojson/node_modules/topojson-client/index.js","topojson-server":"../node_modules/topojson/node_modules/topojson-server/index.js","topojson-simplify":"../node_modules/topojson/node_modules/topojson-simplify/index.js"}],"data/homework-17/counties_with_election_data.topojson":[function(require,module,exports) {
module.exports = "/counties_with_election_data.d38dd575.topojson";
...
var colorScale = d3.scaleLinear().domain([0, 1]).range(['#32CD32', '#FF69B4']);
var opacityScale = d3.scaleLinear().range([0, 1]);
var projection = d3.geoAlbersUsa(); // .scale(600)

var path = d3.geoPath().projection(projection);
d3.json(require('/data/homework-17/counties_with_election_data.topojson')).then(ready).catch(function (err) {
...
function ready(json) {
  ...
  svg.selectAll('path').data(counties.features).enter().append('path').attr('class', 'county').attr('d', path).attr('fill', 'lightgrey').attr('fill', function (d) {
    var total = +d.properties.clinton + +d.properties.trump;
    return colorScale(d.properties.clinton / total);
  }).attr('opacity', function (d) {
    var pops = counties.features.map(function (d) {
      return +d.properties.clinton + +d.properties.trump;
    }); // console.log(d3.max(pops))

    return opacityScale(+d.properties.clinton + +d.properties.trump);
  });
}
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","/data/homework-17/counties_with_election_data.topojson":"data/homework-17/counties_with_election_data.topojson"}]},{},["scripts/homework-17/04a-map.js"], null)
